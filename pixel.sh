...
git clone --depth=1 https://github.com/Iky76/android_device_advan_X1.git -b pixel device/advan/X1
...
git clone https://github.com/G100-X1/device_mediatek_sepolicy_vndr.git -b sixteen-qpr2-rebase device/mediatek/sepolicy_vndr
